...
urlpatterns = [
    ...
    path('api/bookings/<str:booking_code>/', api.api_booking_detail, name='api_booking_detail'),
    path('api/bookings/<str:booking_code>/update-batch/', api.api_booking_update_batch, name='api_booking_update_batch'),
    path('api/bookings/<str:booking_code>/invoice/', api.api_booking_invoice, name='api_booking_invoice'),
    path('api/bookings/<str:booking_code>/invoice/pay/', api.api_booking_invoice_pay, name='api_booking_invoice_pay'),
    path('api/bookings/<str:booking_code>/invoice/refund/', api.api_booking_invoice_refund, name='api_booking_invoice_refund'),
    path('api/booking-requests/', api.api_booking_requests, name='api_booking_requests'),
    path('api/booking-requests/<str:booking_code>/confirm/', api.api_confirm_online_request, name='api_confirm_online_request'),
    ...
    path('api/customers/<str:phone>/note/', api.api_customer_note_update, name='api_customer_note_update'),
    path('api/customers/id/<int:customer_id>/note/', api.api_customer_note_update_by_id, name='api_customer_note_update_by_id'),
]
